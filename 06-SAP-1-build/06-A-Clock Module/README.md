...
1.HIGH or 0 to 1 is called the rising edge of the pulse. the state when the pusle on of the clock is in a transition state of going from 0v to Xv or LOW to 
